...
class TDXAssetIntegration(tdxlib.tdx_integration.TDXIntegration):
    ...
    def make_basic_asset_json(self, asset_values, asset_name, serial_number, status_name, location_name, room_name,
        ...
        expected_replacement_date = acquisition_date + datetime.timedelta(days=(asset_lifespan*365.25))
        ...
        data['LocationRoomID'] = self.get_room_by_name(location, room_name)
        data['Tag'] = asset_tag
        ...
        if attrib_prefix:
            ...
            for key, value in asset_values.items():
                if attrib_prefix in key:
                    ...
                    new_attrib = self.build_asset_custom_attribute_value(attrib, value)
